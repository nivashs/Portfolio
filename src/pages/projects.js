...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    >
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] bg-dark rounded-[2.5rem] rounded-br-3xl"></div>
      <Link
        href={link}
        target="_blank"
...
const Project = ({ title, img, link, type, github }) => {
  return (
    ...
    >
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] bg-dark rounded-[2rem] rounded-br-3xl"></div>
      <Link
        href={link}
        target="_blank"
    ...
    <>
      ...
      <main className="mb-16 flex w-full flex-col items-center justify-center">
        <Layout className="pt-16">
          <AnimatedText text="Curiosity Drives Discovery" className="mb-16" />
